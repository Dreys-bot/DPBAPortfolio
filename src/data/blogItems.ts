...
export const blogItems: BlogItem[] = [
  {
    ...
    content: `
      ...
      <p><img src="${baseURL}img/CNNTrans/transfArchi.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;" /></p>
      <h3>Overview</h3>
      ...
      <p><img src="${baseURL}img/CNNTrans/encDecWorflow.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;" /></p>

      <h2><strong>Encoder Workflow</strong></h2>
      <p><img src="${baseURL}img/CNNTrans/encworkflow.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;" /></p>
      ...
      <p><img src="${baseURL}img/CNNTrans/encworkflowinput.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;" /></p>
      <h3>2. Positional Encoding</h3>
      <img src="${baseURL}img/CNNTrans/positionalenc.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
      ...
      <img src="${baseURL}img/CNNTrans/stackenc.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
      ...
      <img src="${baseURL}img/CNNTrans/normaworkflow.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;"></p>
      ...
      <img src="${baseURL}img/CNNTrans/feedforward.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;"></p>
      ...
      <img src="${baseURL}img/CNNTrans/decoderworkflow.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
      ...
      <img src="${baseURL}img/CNNTrans/multiatten.jpg" alt="architecture"><br>
      ...
      <img src="${baseURL}img/CNNTrans/transoutput.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    author: {
      ...
      image: `${import.meta.env.BASE_URL}img/hero.jpg`,
      alt: 'Mark Thomson',
    },
  ...
  },
  {
    id: 'ai',
    slug: 'rnn',
    image: `${import.meta.env.BASE_URL}img/CNNTrans/blog2.jpg`,
    alt: 'AI Blog',
    tag: 'AI',
    date: 'March 12, 2025',
    ...
    <img src="${baseURL}img/CNNTrans/archiRnn.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:70%; height:auto;">

    <h3>Principal components of RNNs</h3>
    <img src="${baseURL}img/CNNTrans/rnncom.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    <img src="${baseURL}img/CNNTrans/onetoone.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">


    <h3>One-to-Many Architecture</h3>
    <img src="${baseURL}img/CNNTrans/onetomany.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    <img src="${baseURL}img/CNNTrans/manytomany.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    <img src="${baseURL}img/CNNTrans/seqinput.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    <img src="${baseURL}img/CNNTrans/manytomany1.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
  ...
  },
  {
    id: 'serverless',
    slug: 'cnn2',
    image: `${baseURL}img/CNNTrans/cnnspart1.jpg`,
    alt: 'Serverless Blog',
    tag: 'AI',
    date: 'Mar 01, 2025',
    ...
    content: `
      ...
      <img src="${baseURL}img/CNNTrans/form1.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:30%; height:auto;">
      ...
      <img src="${baseURL}img/CNNTrans/form2.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:30%; height:auto;">
      ...
      <img src="${baseURL}img/CNNTrans/form3.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:30%; height:auto;">
      ...
      <img src="${baseURL}img/CNNTrans/form4.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:30%; height:auto;">
      ...
      <img src="${baseURL}img/CNNTrans/form5.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:30%; height:auto;">
      ...
      <img src="${baseURL}img/CNNTrans/form6.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:25%; height:auto;">
      <p>Its derivative is:</p>
      <img src="${baseURL}img/CNNTrans/form7.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:30%; height:auto;">
      ...
      <img src="${baseURL}img/CNNTrans/matrixConv.jpg" alt="architecture" style="display: block; margin: 0 auto; max-width:30%; height:auto;">
  ...
  },
  {
    ...
    <img src="${baseURL}img/CNNTrans/grayeffect.jpg" alt="Edge detection with Sobel filter" />

    <ul>
      <li><strong>Blurring filter (Gaussian Blur)</strong>: Applies a weighted average to smooth an image and reduce noise.</li>
    </ul>
    <img src="${baseURL}img/CNNTrans/blurring.jpg" alt="Gaussian blur application" />

    <ul>
      <li><strong>Sharpening filter</strong>: Enhances edges and improves image sharpness.</li>
    </ul>
    <img src="${baseURL}img/CNNTrans/sharpening.jpg" alt="Sharpen filter application" />

    <h4>2️⃣ Applying the Filter to the Image (Convolution Operation)</h4>

    <img src="${baseURL}img/CNNTrans/filterapply.gif" alt="Filter application example" />
    ...
    <div class="equation">
      <img src="${baseURL}img/CNNTrans/form8.jpg" alt="Filter application example" />
    </div>
  ...
  },
  {
    id: 'microservices',
    slug: 'risecnn',
    image: `${baseURL}img/CNNTrans/cnn.jpeg`,
  ...
  },
  {
    id: 'microservices',
    slug: 'hfl',
    image: `${baseURL}img/Federated/HFL_cover.png`,
    alt: 'Microservices Blog',
    tag: 'AI',
    date: 'March 03, 2024',
    ...
    <img src="${baseURL}img/Federated/HFL_global.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    <img src="${baseURL}img/Federated/HFL.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    <img src="${baseURL}img/Federated/HFL_architecture.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    <img src="${baseURL}img/Federated/cifar10.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">

    <h3>Aggregation functions</h3>

    <img src="${baseURL}img/Federated/functions.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    <ul>
      <li>Federated learning on 3 clients <img src="${baseURL}img/Federated/FL_3.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;"></li>
      <li>Federated learning on 5 clients <img src="${baseURL}img/Federated/FL_5.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;"></li>
      <li>Federated learning on 20 clients <img src="${baseURL}img/Federated/FL_20.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;"></li>
      <li>Federated learning on 50 clients <img src="${baseURL}img/Federated/FL_50.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;"></li>
      <li>Federated learning on 100 clients <img src="${baseURL}img/Federated/FL_100.png" alt="architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;"></li>
    </ul>
    ...
    <ul>
      <li>Variation of learning rate<br>
        <div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
          <img src="${baseURL}img/Federated/CNN_lr_acc.png" alt="architecture" style="max-width:45%; height:auto;">
          <img src="${baseURL}img/Federated/CNN_lr_loss.png" alt="architecture" style="max-width:45%; height:auto;">
        </div>
      </li>

      <li>Variation of decay<br>
        <img src="${baseURL}img/Federated/CNN_decay_acc.png" alt="architecture" style="display: block; margin: 0 auto; max-width:45%; height:auto;">
      </li>
    </ul>
    ...
    <ul>
      <li>Variation of learning rate<br>
        <div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
          <img src="${baseURL}img/Federated/Eff_lr_acc.png" alt="architecture" style="max-width:45%; height:auto;">
          <img src="${baseURL}img/Federated/Eff_lr_loss.png" alt="architecture" style="max-width:45%; height:auto;">
        </div>
      </li>
      <li>Variation of decay<br>
        <div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
          <img src="${baseURL}img/Federated/Eff_decay_acc.png" alt="architecture" style="max-width:45%; height:auto;">
          <img src="${baseURL}img/Federated/Eff_decay_loss.png" alt="architecture" style="max-width:45%; height:auto;">
        </div>
      </li>
    </ul>
  ...
  },
  {
    id: 'microservices',
    slug: 'fl',
    image: `${baseURL}img/Federated/work_FL.png`,
    alt: 'Microservices Blog',
    tag: 'AI',
    date: 'Feb 15, 2024',
    ...
    <p><img src="${baseURL}img/Federated/architecture.png" alt="architecture" style="display: block; margin: 0 auto; max-width:60%; height:auto;"></p>
    ...
    <p><img src="${baseURL}img/Federated/FTL.png" alt="FTL" style="display: block; margin: 0 auto; max-width:60%; height:auto;"></p>
    ...
    <p><img src="${baseURL}img/Federated/VFL.png" alt="VFL" style="display: block; margin: 0 auto; max-width:60%; height:auto;"></p>
    ...
    <p><img src="${baseURL}img/Federated/HFL.png" alt="HFL" style="display: block; margin: 0 auto; max-width:60%; height:auto;"></p>
  ...
  },
  {
    id: 'microservices',
    slug: '3d',
    image: `${baseURL}img/3D/index.jpg`,
    alt: 'Microservices Blog',
    tag: 'AI',
    date: 'Dec 04, 2023',
    ...
    <div class="section">
      ...
      <img src="${baseURL}img/3D/globalGANModel.png" alt="Global GAN Model">
      ...
      <img src="${baseURL}img/3D/GANProcess.png" alt="GAN Process" style="display: block; margin: 0 auto; max-width:60%; height:auto;">
    </div>
    ...
    <div class="section">
      ...
      <img src="${baseURL}img/3D/GANDiagram.png" alt="GAN Diagram">
      ...
      <img src="${baseURL}img/3D/noiseGenerator.png" alt="Noise Generator" style="display: block; margin: 0 auto; max-width:70%; height:auto;">
      ...
      <img src="${baseURL}img/3D/ganNetwork.png" alt="GAN Network" style="display: block; margin: 0 auto; max-width:70%; height:auto;">
      <p>
    ...
    <div class="section">
      ...
      <img src="${baseURL}img/3D/form1.jpg" alt="GAN Network" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
      ...
      <img src="${baseURL}img/3D/graph_KL.png" alt="graph KL" style="display: block; margin: 0 auto; max-width:50%; height:auto;" /></p>

      <img src="${baseURL}img/3D/form2.jpg" alt="graph KL" style="max-width:50%; height:auto;" /></p>
      ...
      <img src="${baseURL}img/3D/Wasserstein1.png" alt="wasserstein" /></p>

      <h1>Types of GAN models</h1>

      <h2>Deep Convolutional Generative Adversial Network</h2>
      <img src="${baseURL}img/3D/DCGAN.png" alt="noise generator" />
      ...
      <img src="${baseURL}img/3D/form1.jpg" alt="noise generator" style="display: block; margin: 0 auto; max-width:50%; height:auto;" />
      ...
      <img src="${baseURL}img/3D/form2.jpg" alt="noise generator" style="display: block; margin: 0 auto; max-width:50%; height:auto;" />
      ...
      <img src="${baseURL}img/3D/form3.jpg" alt="noise generator" style="display: block; margin: 0 auto; max-width:50%; height:auto;" />
      ...
      <img src="${baseURL}img/3D/Wasserstein.png" alt="noise generator" />
      ...
      <img src="${baseURL}img/3D/CycleGan.png" alt="noise generator" />
  ...
  },
  {
    id: 'microservices',
    slug: 'TransformerNLP',
    image: `${baseURL}img/transformer/index.jpg`,
    alt: 'Microservices Blog',
    tag: 'AI',
    date: 'Oct 06, 2023',
    ...
    description:
      "This article gives an in-depth overview of the Transformer architecture, which has revolutionized natural language processing. It focuses on attention blocks, the key component of the model that establishes parallel and contextual connections between words in a sentence.",
    href: `${baseURL}blogs/TransformerNLP`,
    color: 'neon-purple',
    readTime: '8 min read',
    content: `
    ...
    <img src="${baseURL}img/transformer/RNN.png" alt="RNN Architecture">
    ...
    <img src="${baseURL}img/transformer/LSTM.png" alt="LSTM Architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    <h3>Forget gate</h3>
    <img src="${baseURL}img/transformer/porte-doubli-LSTM.gif" alt="Forget Gate">
    ...
    <h3>Input gate</h3>
    <img src="${baseURL}img/transformer/inputGate.gif" alt="Input Gate">
    ...
    <h3>Cell state</h3>
    <img src="${baseURL}img/transformer/cellState.gif" alt="Cell State">
    ...
    <h3>Output gate</h3>
    <img src="${baseURL}img/transformer/outputGate.gif" alt="Output Gate">
    ...
    <img src="${baseURL}img/transformer/The-transformer-model-architecture.png" alt="Transformer Architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
    ...
    <img src="${baseURL}img/transformer/transformer_GPT.png" alt="GPT Architecture" style="display: block; margin: 0 auto; max-width:50%; height:auto;">
...
There are many ways to encode the positions of tokens. For example, we could implement the Positional Encoding layer by using another embedding module (similar to the previous layer), if we pass the position of each token rather than the value of each token as input. Once again, we would start with the weights in this embedding chosen randomly. Then during the training phase, the weights would learn to capture the position of each token.
    ...
    <img src="${baseURL}img/transformer/decoderLayer.png" alt="Decoder Layer">
    ...
    <p><img src="${baseURL}img/transformer/selfAttention.png" alt="multi-headed self-attention" style="display: block; margin: 0 auto; max-width:60%; height:auto;"></p>
  ...
  },
  {
    id: 'microservices',
    slug: 'NeuralStyle',
    image: `${baseURL}img/NeuralStyleTrans/index.jpg`,
    alt: 'Microservices Blog',
    tag: 'AI',
    date: 'Sep 03, 2023',
    ...
    href: `${baseURL}blogs/NeuralStyle`,
    color: 'neon-purple',
    readTime: '8 min read',
    content: `
    ...
    <p><img src="${baseURL}img/NeuralStyleTrans/styleNeuralNetResult1.png" alt="Style Neural Network results"></p>
    ...
    <p><img src="${baseURL}img/NeuralStyleTrans/neuralArchitecture.png" alt="Style Neural Network results" style="display: block; margin: 0 auto; max-width:50%; height:auto;"></p>
    ...
    <p><img src="${baseURL}img/NeuralStyleTrans/CNN_architecture.png" alt="Style Neural Network results"></p>
    ...
    <h3>Style loss</h3>
    <p><img src="${baseURL}img/NeuralStyleTrans/styleLoss.png" alt="Style Neural Network results"></p>
